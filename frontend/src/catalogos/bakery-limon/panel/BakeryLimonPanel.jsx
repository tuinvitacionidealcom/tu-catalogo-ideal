...
const LS_PRODUCTS = 'bakery_limon_products_custom';
const LS_INFO     = 'bakery_limon_info_custom';
const LS_CLICKS   = 'bakery_limon_product_clicks';
...
const defaultProducts = [
  { id: 1, name: 'Espresso Doble (Doppio)', description: 'Café de especialidad 100% Arábica, intenso y aroma persistente.', price: 3200, image: 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?w=600&auto=format&fit=crop&q=60', category: 'CAFÉS & ESPECIALIDADES', available: true, stock: 100 },
  { id: 2, name: 'Cappuccino Limón', description: 'Espresso, leche vaporizada, ralladura de limón orgánico y cacao.', price: 4500, image: 'https://images.unsplash.com/photo-1534778101976-62847782c213?w=600&auto=format&fit=crop&q=60', category: 'CAFÉS & ESPECIALIDADES', available: true, stock: 80 },
  { id: 3, name: 'Flat White', description: 'Doble shot de espresso con capa fina de leche microtexturizada.', price: 4200, image: 'https://images.unsplash.com/photo-1577968897966-3d4325b36b61?w=600&auto=format&fit=crop&q=60', category: 'CAFÉS & ESPECIALIDADES', available: true, stock: 80 },
  { id: 4, name: 'Iced Caramel Latte', description: 'Café espresso frío con leche fresca, sirope de caramelo y hielo.', price: 4800, image: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=600&auto=format&fit=crop&q=60', category: 'CAFÉS & ESPECIALIDADES', available: true, stock: 50 },
  { id: 5, name: 'Medialunas de Manteca (x3)', description: 'Croissants artesanales hojaldrados elaborados con manteca pura.', price: 3600, image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&auto=format&fit=crop&q=60', category: 'PASTELERÍA & DULCES', available: true, stock: 60 },
  { id: 6, name: 'Lemon Pie de la Casa', description: 'Curdo de limón natural sobre sablée y merengue italiano flameado.', price: 5500, image: 'https://images.unsplash.com/photo-1519869325930-281384150729?w=600&auto=format&fit=crop&q=60', category: 'PASTELERÍA & DULCES', available: true, stock: 25 },
  { id: 7, name: 'Cheesecake de Frutos Rojos', description: 'Base mantecosa, crema suave de queso y salsa de frutos del bosque.', price: 5800, image: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=600&auto=format&fit=crop&q=60', category: 'PASTELERÍA & DULCES', available: true, stock: 20 },
  { id: 8, name: 'Avocado Toast & Huevo Poché', description: 'Pan de masa madre, palta pisada con oliva, huevo poché y semillas.', price: 6500, image: 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=600&auto=format&fit=crop&q=60', category: 'DESAYUNOS & MERIENDAS', available: true, stock: 40 },
  { id: 9, name: 'Tostado de Jamón & Queso', description: 'Jamón cocido de primera y queso tybo en pan de campo artesanal.', price: 6200, image: 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=600&auto=format&fit=crop&q=60', category: 'OPCIONES SALADAS', available: true, stock: 45 },
  { id: 10, name: 'Combo Desayuno Clásico', description: 'Café a elección + 2 Medialunas + Vaso de jugo de naranja.', price: 6800, image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&auto=format&fit=crop&q=60', category: 'COMBOS & PROMOS', available: true, stock: 30 }
];

const defaultInfo = {
  name: BUSINESS_NAME,
  description: 'Cafetería de especialidad, pastelería artesanal y medialunas recién horneadas.',
  address: DEFAULT_ADDRESS,
  phone: '5491122525769',
  instagram: 'bakery.limon',
  hours: DEFAULT_HOURS,
};
...
const BirromiPanel = () => {
  ...
  useEffect(() => {
    ...
    return () => document.body.classList.remove('bakery-limon-theme');
  }, []);
  ...
  const fetchProductsFromDB = useCallback(async () => {
    const catalogId = user?.catalog_id || 3;
    try {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '13px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
              ...
              <button
                type="button"
                onClick={() => document.getElementById('bakery-image-file-input')?.click()}
