...
const LOCAL_STORAGE_PRODUCTS_KEY = 'bakery_limon_products_custom';
const LOCAL_STORAGE_INFO_KEY = 'bakery_limon_info_custom';

const defaultProducts = [
  // CAFÉS & ESPECIALIDADES
  {
    id: 1,
    name: 'Espresso Doble (Doppio)',
    description: 'Extracción de café de especialidad 100% Arábica, intenso, con crema densa y aroma persistente.',
    price: 3200,
    image: 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?auto=format&fit=crop&w=600&q=80',
    category: 'CAFÉS & ESPECIALIDADES',
    available: true
  },
  {
    id: 2,
    name: 'Cappuccino Limón',
    description: 'Especialidad de la casa: Espresso, leche vaporizada cremosa, ralladura de limón orgánico y lluvia de cacao amargo.',
    price: 4500,
  ...
  },
  {
    id: 3,
    name: 'Flat White',
    description: 'Doble shot de espresso con capa fina de leche microtexturizada, sedoso y con marcado sabor a café.',
    price: 4200,
  ...
  },
  {
    ...
    description: 'Café espresso frío con leche fresca, sirope artesanal de caramelo y hielo picado.',
    price: 4800,
  ...
  {
    id: 5,
    name: 'Submarino Tradicional',
    description: 'Leche caliente espumada servida con barra de chocolate alpino artesanal para fundir en mesa.',
    price: 4500,
  ...
  {
    id: 6,
    name: 'Medialunas de Manteca (x3)',
    description: 'Croissants artesanales hojaldrados elaborados con manteca pura, suaves y dorados en su punto justo.',
    price: 3600,
    image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&w=600&q=80',
    category: 'PASTELERÍA & DULCES',
    available: true
  },
  {
    id: 7,
    name: 'Lemon Pie de la Casa',
    description: 'Masa sablée crocante, cremoso curdo de limón natural y copón de merengue italiano flameado.',
    price: 5500,
  ...
  },
  {
    ...
    description: 'Base de galletita mantecosa, relleno suave de queso crema y salsa casera de frutos del bosque.',
    price: 5800,
  ...
  {
    id: 9,
    name: 'Tarta de Ricota & Limón',
    description: 'Receta familiar con suave crema de ricota magra, toque de vainilla y ralladura de limón.',
    price: 4900,
  ...
  {
    id: 10,
    name: 'Alfajor Artesanal Sablée',
    description: 'Masa sablée suave rellena de abundante dulce de leche repostero y rebozado en coco o chocolate.',
    price: 2800,
  ...
  // DESAYUNOS & MERIENDAS / OPCIONES SALADAS
  {
    id: 11,
    name: 'Avocado Toast & Huevo Poché',
    description: 'Pan de masa madre tostado, abundante palta pisada con oliva, huevo poché y lluvia de semillas.',
    price: 6500,
  ...
  },
  {
    ...
    description: 'Jamón cocido de primera calidad y queso tybo gratinado en pan de campo artesanal.',
    price: 6200,
  ...
  {
    id: 13,
    name: 'Croissant Relleno Jamón Crudo & Queso',
    description: 'Croissant hojaldrado caliente con jamón crudo estacionado, queso gouda y hojas frescas de rúcula.',
    price: 6900,
  ...
  {
    id: 14,
    name: 'Sándwiches de Miga Triples (x2)',
    description: 'Pan fresco de miga fina elaborado en el día con jamón, queso y aderezo especial.',
    price: 4200,
  ...
  // COMBOS & PROMOS
  {
    ...
    description: 'Café a elección + 2 Medialunas de manteca recién horneadas + vaso de jugo de naranja exprimido.',
    price: 6800,
  ...
  {
    id: 16,
    name: 'Promo Merienda Bakery (Para 2)',
    description: '2 Cafés o Cappuccinos + Porción de Lemon Pie o Cheesecake + 2 Medialunas o tostados.',
    price: 13500,
...
const defaultInfo = {
  name: BUSINESS_NAME,
  description: "Cafetería de especialidad, pastelería artesanal y medialunas de manteca recién horneadas en Villa Bosch.",
...
const BakeryLimonCatalogo = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.body.classList.remove('bakery-limon-theme');
...
export default BakeryLimonCatalogo;
