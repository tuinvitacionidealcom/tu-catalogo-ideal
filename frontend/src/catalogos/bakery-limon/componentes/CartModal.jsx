...
const CartModal = ({ isOpen, onClose, cartItems, products = [], onAdd, onRemove, onClear, whatsappNumber }) => {
  ...
  const handleSendOrder = () => {
    ...
    let message = `☕ *PEDIDO CAFETERÍA - BAKERY LIMÓN* 🥐\n\n`;
          ...
          {cartItems.length === 0 ? (
            <div className="h-full flex flex-col justify-between py-4">
              ...
              <div className="flex flex-col items-center justify-center text-center py-6">
                ...
                <p className="text-[11px] text-slate-400 font-medium mt-0.5">¡Agregá tus cafés y delicias favoritas para empezar!</p>
              </div>
              ...
              <div className="border-t border-slate-100 pt-6 mt-4 text-left">
                ...
                <div className="space-y-3.5">
                  {[
                    { id: 2, name: 'Cappuccino Limón', price: 4500, desc: 'Espresso, leche vaporizada y ralladura de limón.' },
                    { id: 6, name: 'Medialunas de Manteca (x3)', price: 3600, desc: 'Hojaldradas, suaves y doradas.' },
                    { id: 7, name: 'Lemon Pie de la Casa', price: 5500, desc: 'Curd de limón y merengue flameado.' }
                  ].map((prod) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          onClick={() => onAdd({ ...prod, image: img, category: prod.id === 2 ? 'CAFÉS & ESPECIALIDADES' : 'PASTELERÍA & DULCES', available: true })}
