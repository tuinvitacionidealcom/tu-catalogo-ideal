...
const defaultProducts = [
  { id: 1, name: 'Ambientaciones', description: 'Diseñamos y decoramos cada rincón para que tu evento sea único y mágico. Consultanos para conocer opciones y presupuesto a medida.', price: 0, image: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=600&auto=format&fit=crop&q=60', category: 'SERVICIOS', available: true },
  { id: 2, name: 'Fiesta del Té', description: 'Toda la vajilla, decoración y detalles especiales para una tarde de té inolvidable con tus invitados.', price: 0, image: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=600&auto=format&fit=crop&q=60', category: 'SERVICIOS', available: true },
  { id: 3, name: 'Glitter Bar', description: '¡Mucho brillo para tu fiesta! Un espacio divertido donde grandes y chicos pueden lookearse con maquillajes y glitter.', price: 0, image: 'https://images.unsplash.com/photo-1595959183082-7b570b7e08e2?w=600&auto=format&fit=crop&q=60', category: 'SERVICIOS', available: true }
];

const defaultInfo = {
  name: BUSINESS_NAME,
  description: 'Soy Julieta y te ayudo a que tu evento sea inolvidable!!🎉\nRealizo ambientaciones 🌟\nFiesta del té ☕️🎂\nGlitter Bar ✨️✨️✨️\nCiudad Autónoma de BsAs',
...
// â”€â”€ Sheet Modal (slide desde abajo) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const celebrartePanel = () => {
  ...
  useEffect(() => {
    ...
    return () => document.body.classList.remove('celebrarte-theme');
  }, []);

  // â”€â”€ Persist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Popular â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const formatDate = (d) => !d ? 'â€”' : new Date(d).toLocaleDateString('es-AR', {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, fontFamily: "'Inter', sans-serif", maxWidth: '480px', margin: '0 auto', position: 'relative' }}>
      ...
      <main style={{ padding: '18px 16px 60px' }}>
        ...
        {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ MI COMERCIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        {activeSection === 'info' && (
          <form
            onSubmit={async e => {
              e.preventDefault();
        ...
        {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ MÃS PEDIDOS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
                  ...
                  return (
                    <div key={p.id} style={{
                      ...
                      <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: isTop3 ? medalColors[i] : '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                        {i === 0 ? 'ðŸ¥‡' : i === 1 ? 'ðŸ¥ˆ' : i === 2 ? 'ðŸ¥‰' : <span style={{ fontSize: '12px', fontWeight: 800, color: '#94a3b8' }}>#{i + 1}</span>}
                      </div>
        ...
        {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ ESTADÃSTICAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        {activeSection === 'stats' && (
          <div>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '18px' }}>
              <div>
        ...
        {/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ CONSULTAS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '8px' }}>
              <input
                type="file"
                accept="image/*"
                id="celebrarte-image-file-input"
                style={{ display: 'none' }}
                onChange={async (e) => {
              ...
              <button
                type="button"
                onClick={() => document.getElementById('celebrarte-image-file-input')?.click()}
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â• MODAL: Stock â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <Sheet
        open={stockModal.open}
        onClose={() => setStockModal({ open: false, product: null, input: '' })}
        title="âœï¸ Cambiar Stock"
      >
        {stockModal.product && (
          <div>
...
export default celebrartePanel;
