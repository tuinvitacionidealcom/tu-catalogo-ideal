...
import { Star, Coffee, Sparkles, CreditCard } from 'lucide-react';
...
const ServiciosSeccion = () => {
  const servicios = [
    {
      ...
      description: "Diseñamos la decoración de tu evento de principio a fin."
    },
    {
      icon: <Coffee className="w-6 h-6 text-accent" />,
      title: "Fiesta del Té",
      description: "Vajilla completa y decoración para una tarde inolvidable."
    },
    {
      icon: <Sparkles className="w-6 h-6 text-accent" />,
      title: "Glitter Bar",
      description: "Maquillaje y brillos para darle color a tu fiesta."
    },
    {
  ...
  // Manejar transiciÃ³n con animaciÃ³n
  ...
  return (
    <div className="bg-brand text-white border-y border-white/5 py-8 px-6 overflow-hidden relative">
      ...
      >
        {/* Contenedor con altura fija mÃ¡s alta y animaciÃ³n fluida de entrada/salida */}
