...
const file = path.join(__dirname, 'frontend/src/catalogos/celebrarte-julieta/panel/CelebrartePanel.jsx');
...
// 3. Refactor Stock
const stockOld = `  const nudgeStock = (id, delta) =>
...
const stockNew = `  const saveStockToDB = async (productToSave, newStock) => {
    try {
      const token = getToken();
      const clean = {
        ...productToSave,
...
console.log('Done refactoring frontend CelebrartePanel.jsx');
